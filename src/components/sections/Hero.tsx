...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-surface pt-28 md:pt-32 lg:pt-36 pb-6 md:pb-20 lg:pb-24 xl:min-h-screen xl:supports-[height:100dvh]:min-h-[100dvh] xl:flex xl:items-center">
      <div
